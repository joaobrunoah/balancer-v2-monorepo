...
describe('GearboxLinearPool', function () {
  ...
  sharedBeforeEach('deploy tokens', async () => {
    ...
    wrappedToken = await deploy('MockGearboxDieselToken', { args: ['dUSDC', 'dUSDC', 18, mainToken.address] });
  ...
  describe('getWrappedTokenRate', () => {
    it('returns the expected value', async () => {
      ...
      await wrappedToken.setRate(bn(1e27));
      ...
      await wrappedToken.setRate(bn(2e27));
